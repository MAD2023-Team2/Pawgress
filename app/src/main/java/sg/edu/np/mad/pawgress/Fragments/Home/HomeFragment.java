...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (user.getPetDesign() == 2131165287){pet_picture.setImageResource(R.drawable.grey_cat);}
        else if (user.getPetDesign() == 2131165340){pet_picture.setImageResource(R.drawable.orange_cat);}
        else if (user.getPetDesign() == 2131165280){pet_picture.setImageResource(R.drawable.corgi);}
